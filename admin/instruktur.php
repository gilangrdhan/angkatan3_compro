                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($query)) { ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td>
                                                            <img src="upload/<?php echo $row ['foto']?>" width="100" alt="">
                                                        </td>
                                                        <td><?php echo $row['nama_instruktur'] ?></td>
                                                        <td><?php echo $row['jurusan_instruktur'] ?></td>
                                                        <td>
                                                            <a href="tambah-instruktur.php?edit=<?php echo $row['id'] ?>" class="btn btn-secondary btn-sm">
                                                                <span class="tf-icon bx bx-pencil"></span>
                                                            </a>
                                                            <a onclick="return confirm ('Apakah anda yakin menghapus data ini???')" href="instruktur.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">
