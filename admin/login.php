...
session_start();
include 'koneksi.php';
// ngambil dari submit ditekan
if (isset($_POST['login'])){
    $email      = $_POST['email']; //utk mengambil nilai dari input
    $password   = $_POST ['password'];

    $queryLogin = mysqli_query($koneksi, "SELECT * FROM user WHERE email= '$email'");
    // mysqli_num_row() : utk melihat total data didalam table
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Silanhkan masuk dengan akun anda</p>
