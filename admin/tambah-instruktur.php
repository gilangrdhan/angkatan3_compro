...
if (isset($_POST['simpan'])) {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (!in_array($extFoto, $ext)) {
            ...
            $sql = "INSERT INTO instruktur (nama_instruktur,jurusan_instruktur,foto) VALUES ('$nama_instruktur','$jurusan_instruktur','$nama_foto')";
            $insert = mysqli_query($koneksi, $sql);
        }
    } else {
        $sql = "INSERT INTO instruktur (nama_instruktur,jurusan_instruktur) VALUES ('$nama_instruktur','$jurusan_instruktur')";
        $insert = mysqli_query($koneksi, $sql);
    }
...
if (isset($_POST['edit'])) {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (!in_array($extFoto, $ext)) {
            ...
            // Coding ubah atau update disini
        ...
        //kondisi kalau user tidak ingin memasukan gambar
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        placeholder="masukkan jurusan instruktur" required>
                                                </div>
                                                <!-- <div class="mb-3 row">
                                                    <div class="col-sm-12">
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-12">
                                                        <label for="" class="m-3" form-label>Foto</label>
                                                        <input type="file"
                                                            name="foto">
